...
Public Class Form1
    ...
    Sub EjecutaOperaciones()
        ...
        If bModoFraccion = True Then
            ...
            'modo fracción primer y segundo operando.
            'habilita almacenar el segundo operario Fraccion Dos
    ...
    Sub OperacionSuma()
        If bModoFraccion = True Then
            ...
            ' doble, si son divisibles, luego se toma como factor comun
            '-------------------------------------
            '06/07/2023 NO FUNCIONA DE ESTA FORMA
            ' crear funcion para DCM
            '-------------------------------------
            'res = CDbl(F2b) Mod CDbl(F2c) 
    ...
    Sub AlmacenaOperandoFraccionUnoEnMemoria()
        ...
        Else
            ...
            iFraccionA(1) = Math.Truncate(CInt(Convierte(tbDisplay.Text)))
        End If
